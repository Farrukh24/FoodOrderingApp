...
namespace OnlineFoodOrderingSystem.Migrations
{
    ...
    [Migration("20210924183734_AddDataToDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineFoodOrderingSystem.Models.Entities.Feedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineFoodOrderingSystem.Models.Entities.FoodPlace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineFoodOrderingSystem.Models.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineFoodOrderingSystem.Models.Entities.Feedback", b =>
                {
                    b.HasOne("OnlineFoodOrderingSystem.Models.Entities.Product", "Product")
                        .WithMany("Feedbacks")
            ...
            modelBuilder.Entity("OnlineFoodOrderingSystem.Models.Entities.Product", b =>
                {
                    b.HasOne("OnlineFoodOrderingSystem.Models.Entities.FoodPlace", "Place")
                        .WithMany("Products")
